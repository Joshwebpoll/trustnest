                ...
                <table width="600" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
                    ...
                    <tr>
                        <td bgcolor="#4A90E2" style="padding: 20px 30px; color: #ffffff; text-align: center;">
                            <h1 style="margin: 0; font-size: 24px;">Loan Application Status</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            ...
                            <p style="font-size: 15px; color: #333;">Thank you for applying for a loan with us. Your
                                application has been {{ $loan->status }}</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px 20px;">
                                        ₦{{ number_format(Crypt::decryptString($loan->amount)) }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 12px 20px;">
                                        ₦{{ number_format(Crypt::decryptString($loan->total_payable)) }}
                                    </td>
                                </tr>
                                <tr>
